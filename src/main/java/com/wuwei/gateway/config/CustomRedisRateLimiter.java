...
import com.wuwei.gateway.common.CommonConstants;
import com.wuwei.gateway.common.LimiterLevelResolver;
import com.wuwei.gateway.common.RateLimiterLevel;
import com.wuwei.gateway.common.RateLimiterVO;
...
//        RateLimiterLevel rateLimiterLevel = limiterLevelResolver.get();
        ...
        List<RateLimiterVO> limiterVOList = new ArrayList<RateLimiterVO>();
        RateLimiterVO rateLimiterVO1 = new RateLimiterVO();
        rateLimiterVO1.setBurstCapacity(40);
        rateLimiterVO1.setLevel("1");
        rateLimiterVO1.setLevelName("本地自定义限流规则");
        rateLimiterVO1.setLimitId(1);
        rateLimiterVO1.setLimitType(1);
        rateLimiterVO1.setReplenishRate(40);
        limiterVOList.add(rateLimiterVO1);
        rateLimiterLevel.setLevels(limiterVOList);
